...
{
    public sealed class MatchClue : absClue
    {
        ...
        public MatchClue(string clueText,
            ...
            : base(clueText)
        {
            ...
            {
                throw new ArgumentException("A match clue must use two different categories.");
            }
